...
"""
This module contains everything needed to setup a streamlit ui.
"""
...
def get_image_download_link(input_img, filename="result.png", text="Download result"):
    """
    This function is for getting image download link and provide it to strealit ui.

    Parameters
    ----------
    input_img: numpy array of desired image.
    filename: str ; name of the file to download; default is "result.png"
    text: str ; default is "Download result"

    Returns
    -------
    href: str ; a formated string to give to streamlit for each input image.
    """
